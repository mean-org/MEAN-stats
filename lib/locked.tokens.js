...
class LockedTokens {
    ...
    getCurrentTokenSupply() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                accInfo = (yield this.connection.getParsedAccountInfo(this.tokenAddress)).value;
            }
            catch (error) {
            ...
            if (accInfo) {
                ...
                if (data.parsed) {
                    return (0, utils_1.normalizeTokenAmount)(data.parsed.info.supply, data.parsed.info.decimals);
                }
            }
            return 0;
        });
